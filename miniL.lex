...
{GT}           { return GT; }
	...
	/* identifiers */
{IDENT_ERROR_1}       { printf("Error at line %d, identifier \"%s\" must begin with a letter.", currentRow, yytext); return;}
{IDENT_ERROR_2}       { printf("Error at line %d, identifier \"%s\" cannot end with an underscore.", currentRow,  yytext); return;}
{IDENT}               { yylval.ival = yytext; return IDENTIFIER;  }
